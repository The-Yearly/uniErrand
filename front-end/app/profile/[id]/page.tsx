    ...
    { id: 3, title: "House Cleaning", status: "posted", date: "2024-01-13", payment: "$50" },
    ]

    const completedJobs = [
    { id: 1, title: "Furniture Assembly", client: "Sarah M.", rating: 5, payment: "$40" },
    { id: 2, title: "Garden Maintenance", client: "Mike R.", rating: 4, payment: "$35" },
    ...
    const renderStars = (rating: number) => {
        ...
        star <= rating ? (
            ...
            <StarHalf size={16} className="absolute fill-yellow-400 text-yellow-400" />
    ...
    return (
        ...
        <div className="pt-20">
            ...
            <aside className="hidden lg:block w-80 bg-white shadow-xl border-r border-white/30 lg:rounded-r-2xl">
                ...
                <h1 className="text-3xl mt-8 font-bold text-center text-gray-800">Dashboard</h1>
                ...
                <nav className="flex flex-col mt-10 space-y-2">
                    ...
                    className="flex items-center text-lg gap-4 px-4 py-3 rounded-lg transition-all hover:bg-gray-100 hover:text-gray-900"
                    >
                    <MessageCircleQuestionMark strokeWidth={1.25} className="w-6 h-6" />
                    <span>Reviews</span>
                    </Link>
                </nav>
                </div>
                ...
                <section className="grid grid-cols-1 xl:grid-cols-2 gap-6 mb-8">
                    ...
                    <div className="p-4 lg:p-6">
                        ...
                        <div className="flex-1 text-center sm:text-left">
                            <h2 className="text-xl lg:text-2xl font-semibold text-gray-900">John Yohan</h2>
                            ...
                            {renderStars(4.8)}
                            <span className="ml-2 text-sm text-gray-500">{(4.8).toFixed(1)} / 5</span>
                            </div>
                    ...
                    <div className="p-4 lg:p-6">
                        ...
                        <div className="text-center p-3 lg:p-4 bg-blue-50 rounded-lg">
                            ...
                            <p className="text-xs lg:text-sm text-gray-600">Jobs Posted</p>
                        </div>
                        ...
                        <div className="text-center p-3 lg:p-4 bg-yellow-50 rounded-lg">
                            <p className="text-xl lg:text-2xl font-bold text-yellow-600">$340</p>
                            <p className="text-xs lg:text-sm text-gray-600">Total Earned</p>
                        </div>
                        <div className="text-center p-3 lg:p-4 bg-purple-50 rounded-lg">
                            <p className="text-xl lg:text-2xl font-bold text-purple-600">4.8</p>
                ...
                <section className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                    ...
                    <div className="p-4 lg:p-6">
                        ...
                        {recentJobs.map((job) => (
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-xs lg:text-sm text-gray-500">{job.date}</p>
                            </div>
                            <div className="flex items-center gap-2 justify-between sm:justify-end">
                                ...
                                <span className="font-medium text-green-600 text-sm lg:text-base">{job.payment}</span>
                            </div>
                            </div>
                        ))}
                        </div>
                    ...
                    <div className="p-4 lg:p-6">
                        ...
                        {completedJobs.map((job) => (
                            ...
                            <div className="flex-1">
                                <h3 className="font-medium text-gray-900 text-sm lg:text-base">{job.title}</h3>
                                <p className="text-xs lg:text-sm text-gray-500">Client: {job.client}</p>
                            </div>
                            <div className="flex items-center gap-2 justify-between sm:justify-end">
                                <div className="flex gap-0.5">{renderStars(job.rating)}</div>
                                <span className="font-medium text-green-600 text-sm lg:text-base">{job.payment}</span>
                            </div>
                            </div>
                        ))}

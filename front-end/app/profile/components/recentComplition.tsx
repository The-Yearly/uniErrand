...
export default function RecentComplition({completedJobs}:{completedJobs:CompletedJob[]}){
    return(
                      <section>
                        ...
                        >
                          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3">
                            <div className="flex-1">
                              ...
                              <p className="text-sm text-gray-600 mb-1">Client: {job.client}</p>
                              <p className="text-sm text-gray-500 italic">"{job.feedback}"</p>
                            </div>
                            <div className="flex items-center gap-4">
                              <span className="text-xs text-gray-500">{job.date}</span>
                              <span className="font-bold text-emerald-600 text-lg">${job.payment}</span>
                            </div>
                          </div>
                        </div>
                      ))}

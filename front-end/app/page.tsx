...
export default function Home() {
  ...
  return (
    ...
    <motion.div
      ...
      transition={{duration:1,scale:{type:"spring",visualDuration:1,bounce:0.2}}}
      ...
      <div className="flex flex-col items-center mt-10 px-4 text-center space-y-6">
        ...
        <p className="max-w-2xl text-lg text-gray-600">
          Connect with fellow students to get tasks done quickly and efficiently. 
          Whether it’s picking up groceries, delivering a forgotten item, or any other 
          campus errand, we’ve got you covered.
        </p>
